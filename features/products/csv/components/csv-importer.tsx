...
import { useParseCsv } from "@/features/products/csv/hooks/use-parse-csv"
import { useUploadFile } from "@/features/products/csv/hooks/use-upload-file"
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      {step === "upload" ? (
        ...
        <DialogContent className="p-8 max-w-6xl">
          ...
          <div className="flex-1 min-h-0 py-6  overflow-auto">
